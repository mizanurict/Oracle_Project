...
<report name="join_customer_item" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="JOIN_CUSTOMER_ITEM" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <userParameter name="CODEP" datatype="character" width="40"
     defaultWidth="0" defaultHeight="0"/>
    <dataSource name="Q_1">
      <select canParse="no">
      <![CDATA[SELECT All_Customer.code, All_Customer.customer_name, All_Customer.line, Item_Master.item_code, Item_Master.item_name, Item_Master.mrp
FROM All_Customer
...
inner JOIN Item_Master ON All_Customer.line = Item_Master.line
      ...
      <group name="G_CODE">
        <displayInfo x="1.19421" y="1.94995" width="1.61169" height="1.28516"
        />
        <dataItem name="CODE" datatype="vchar2" columnOrder="11" width="26"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Code">
          <dataDescriptor expression="CODE" descriptiveExpression="CODE"
           order="1" width="26"/>
        ...
        <dataItem name="CUSTOMER_NAME" datatype="vchar2" columnOrder="12"
         ...
         columnFlags="1" defaultLabel="Customer Name">
          <dataDescriptor expression="CUSTOMER_NAME"
           descriptiveExpression="CUSTOMER_NAME" order="2" width="128"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="LINE" datatype="vchar2" columnOrder="13" width="26"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Line">
          <dataDescriptor expression="LINE" descriptiveExpression="LINE"
           order="3" width="26"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="ITEM_CODE" datatype="vchar2" columnOrder="14"
         width="26" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Item Code">
          <dataDescriptor expression="ITEM_CODE"
           descriptiveExpression="ITEM_CODE" order="4" width="26"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="ITEM_NAME" datatype="vchar2" columnOrder="15"
         width="128" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Item Name">
          <dataDescriptor expression="ITEM_NAME"
           descriptiveExpression="ITEM_NAME" order="5" width="128"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="MRP" oracleDatatype="number" columnOrder="16"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Mrp">
          <dataDescriptor expression="MRP" descriptiveExpression="MRP"
      ...
      <frame name="M_G_CODE_GRPFR">
        ...
        <repeatingFrame name="R_G_CODE" source="G_CODE" printDirection="down"
         minWidowRecords="1" columnMode="no">
          ...
          <field name="F_CODE" source="CODE" minWidowLines="1" spacing="0"
           alignment="start">
          ...
          <field name="F_CUSTOMER_NAME" source="CUSTOMER_NAME"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="1.18750" y="0.18750" width="1.18750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_LINE" source="LINE" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="2.37500" y="0.18750" width="1.18750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_ITEM_CODE" source="ITEM_CODE" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="3.56250" y="0.18750" width="1.18750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_ITEM_NAME" source="ITEM_NAME" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="4.75000" y="0.18750" width="1.18750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_MRP" source="MRP" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
        ...
        <frame name="M_G_CODE_HDR">
          ...
          <text name="B_CODE" minWidowLines="1">
          ...
          <text name="B_CUSTOMER_NAME" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.18750" y="0.00000" width="1.18750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_LINE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="2.37500" y="0.00000" width="1.18750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_ITEM_CODE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="3.56250" y="0.00000" width="1.18750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_MRP" minWidowLines="1">
            <textSettings spacing="0"/>
...
<rw:dataArea id="MGCODEGRPFR91">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBCODE91" asArray="no"/> class="OraColumnHeader"> Code </th>
   <th <rw:id id="HBCUSTOMERNAME91" asArray="no"/> class="OraColumnHeader"> Customer Name </th>
   <th <rw:id id="HBLINE91" asArray="no"/> class="OraColumnHeader"> Line </th>
   <th <rw:id id="HBITEMCODE91" asArray="no"/> class="OraColumnHeader"> Item Code </th>
   <th <rw:id id="HBITEMNAME91" asArray="no"/> class="OraColumnHeader"> Item Name </th>
   <th <rw:id id="HBMRP91" asArray="no"/> class="OraColumnHeader"> Mrp </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGCODE911" src="G_CODE">
   <tr>
    <td <rw:headers id="HFCODE91" src="HBCODE91"/> class="OraCellText"><rw:field id="FCODE91" src="CODE" nullValue="&nbsp;"> F_CODE </rw:field></td>
    <td <rw:headers id="HFCUSTOMERNAME91" src="HBCUSTOMERNAME91"/> class="OraCellText"><rw:field id="FCUSTOMERNAME91" src="CUSTOMER_NAME" nullValue="&nbsp;"> F_CUSTOMER_NAME </rw:field></td>
    <td <rw:headers id="HFLINE91" src="HBLINE91"/> class="OraCellText"><rw:field id="FLINE91" src="LINE" nullValue="&nbsp;"> F_LINE </rw:field></td>
    <td <rw:headers id="HFITEMCODE91" src="HBITEMCODE91"/> class="OraCellText"><rw:field id="FITEMCODE91" src="ITEM_CODE" nullValue="&nbsp;"> F_ITEM_CODE </rw:field></td>
    <td <rw:headers id="HFITEMNAME91" src="HBITEMNAME91"/> class="OraCellText"><rw:field id="FITEMNAME91" src="ITEM_NAME" nullValue="&nbsp;"> F_ITEM_NAME </rw:field></td>
    <td <rw:headers id="HFMRP91" src="HBMRP91"/> class="OraCellNumber"><rw:field id="FMRP91" src="MRP" nullValue="&nbsp;"> F_MRP </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
</table>
